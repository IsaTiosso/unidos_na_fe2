    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          _buildAlternativaBotao('A', 'Um jogador de futebol.'),
          SizedBox(height: 12),
          _buildAlternativaBotao('B', 'Um profeta muito importante para os cristãos.'),
          SizedBox(height: 12),
          _buildAlternativaBotao('C', 'Um personagem de desenho animado.'),
        ],
      ),
    );
  }
